...
import com.stucom.alu2015018.p1_menuprincipal.gamep3.Input;
import com.stucom.alu2015018.p1_menuprincipal.gamep3.Scene;
...
public class Bonk extends Character {
    ...
    void updatePhysics(int delta) {
        ...
        // If died, no physics
        if (state == 3 || gameEngine.playerLifes == 0) return;
        ...
        if (y >= (scene.getHeight() - COL_HEIGHT)) {
            die();
            Log.d("sergio", "Muerte");
        } else {
            // state change
